...
SideScroller.Level2.prototype = {
    ...
    create: function () {
        ...
        this.map = this.game.add.tilemap('level2');
            ...
            this.map.addTilesetImage('mushroomtops', 'l2BlockedTiles');
            this.map.addTilesetImage('tiles_spritesheetCLEAR', 'l2BlockedTiles2');
            //this.map.addTilesetImage('tiles_spritesheet', 'blockedTiles');
            this.map.addTilesetImage('level2bg', 'level2Background');
            this.map.addTilesetImage('blank', 'blank');
       ...
       //the first parameter is the tileset name as specified in Tiled, the second is the key to the asset
        ...
        this.level2Music = this.game.add.audio('level2Music', 0.5, true);
    ...
    createItems: function () {
        ...
        // LEVEL SPECIFIC //
        //                //
        this.addItemLayer('stemBase');
        this.addItemLayer('stemTop');
        this.addItemLayer('stem');
